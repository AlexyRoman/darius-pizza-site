 ...
 * that can be used across different applications. App-specific configuration
 * (like redirect mappings) is loaded from middleware.json.
 *
 ...
 * Loaded from middleware.json - app-specific configuration
