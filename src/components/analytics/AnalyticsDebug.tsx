...
export default function AnalyticsDebug() {
  const [preferences, setPreferences] =
    useState<ReturnType<typeof getCookiePreferences>>(null);
  ...
  return (
    ...
    >
      ...
      <div>
        <strong>Preferences:</strong> {JSON.stringify(preferences)}
      </div>
      <div>
        <strong>GA ID:</strong> {process.env.NEXT_PUBLIC_GA_ID}
      </div>
      <div>
        <strong>GTM ID:</strong> {process.env.NEXT_PUBLIC_GTM_ID}
      </div>
      <div>
